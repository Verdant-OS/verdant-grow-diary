...
function baseVm(state: HarvestWatchV0ReadinessState) {
  ...
  return {
    ...
    evidenceExplanation: "No diary entries flagged as photo evidence yet.",
    evidenceGalleryMismatch: false,
    evidenceMismatchNote: "",
    photoEvidenceDisplay: {
      count: 0,
      label: "0 photo evidence points",
      explanation: "No diary entries flagged as photo evidence yet.",
      hasGalleryMismatch: false,
      mismatchNote: "",
      dataSource: "unknown" as const,
      sourceLabel: "Source: Unspecified",
      showSupportingRecordsCta: false,
      supportingRecordsHref: "#plant-recent-activity",
      supportingRecordsCtaLabel: "View related activity",
      supportingRecordsCtaAriaLabel: "View supporting photo evidence in Recent Activity.",
    },
