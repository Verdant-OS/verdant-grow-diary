...
export default defineTool({
  ...
  description:
    ...
    "evidence and source limits; archived targets are labeled historical; exact sensor evidence is loaded only by get_grow_walk_context. " +
    "Priority is scouting guidance, not a diagnosis. Read-only.",
  inputSchema: {
