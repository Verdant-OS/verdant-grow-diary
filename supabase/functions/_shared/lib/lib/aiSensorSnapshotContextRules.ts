...
// sha256: 7be6cac6b08c1acb7562429c71dac4ab73f5dc4f23b75cbd7674b3d52b1e8a0a
 ...
 */
import { isDiagnosticSensorProvenanceRow } from "./sensorProvenanceFenceRules.ts";

import { DEFAULT_AI_SENSOR_STALE_THRESHOLD_MS } from "../constants/sensorTiming.ts";
import { resolveCurrentStateStaleWindowMs } from "./sensorTruthCanon.ts";
