            ...
            >
              ...
              {item.cta && (
                <Link
                  ...
                  className={`mt-1 flex min-h-10 w-full items-center justify-center rounded-md border border-border bg-secondary px-3 py-2 text-xs text-secondary-foreground ${AI_DOCTOR_PHASE1_FOCUS_VISIBLE_LINK_CLASSES} sm:inline-flex sm:w-auto`}
                >
                  {item.cta.label}
                </Link>
              )}
