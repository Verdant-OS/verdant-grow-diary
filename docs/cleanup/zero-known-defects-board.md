...
| [#596](https://github.com/Verdant-OS/verdant-grow-diary/issues/596)                                                                     | Environment checks never reach alert evaluation; environment_events is write-only (both Quick Log variants)                                           | OPEN — product decision needed                            |
