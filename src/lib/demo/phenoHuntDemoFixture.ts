...
const DEMO_CANDIDATES_RAW: readonly Omit<DemoCandidate, "plantType" | "stage">[] = [
  {
    candidateNumber: 1,
    name: "Runtz #1",
    strain: "Sunset Runtz F2",
    aroma: ["candy", "fuel"],
    verdict: "cull",
    winnerScore: 41,
    loud: { nose: 5, resin: 4, structure: 4, yield: 6, breeding: 3 },
    tags: [],
    rounds: ["veg", "mid_flower"],
    mother: false,
    note: "Thin, faded early.",
  },
  {
    candidateNumber: 2,
    name: "Runtz #2",
    ...
    verdict: "maybe",
    winnerScore: 62,
    loud: { nose: 7, resin: 6, structure: 6, yield: 6, breeding: 5 },
    tags: [],
    rounds: ["veg", "mid_flower", "late_flower"],
    mother: false,
    note: "Watch — decent nose, run again.",
  },
  {
    candidateNumber: 3,
    name: "Gas Runtz",
    strain: "Sunset Runtz F2",
    aroma: ["diesel", "gas", "candy"],
    verdict: "keep",
    winnerScore: 88,
    loud: { nose: 9, resin: 8, structure: 7, yield: 7, breeding: 8 },
    tags: ["Resin bomb"],
    rounds: ["veg", "early_flower", "mid_flower", "late_flower", "post_cure"],
    mother: true,
    note: "Loud gas; held up post-cure across two runs.",
  },
  {
    candidateNumber: 4,
    name: "Runtz #4",
    ...
    verdict: "cull",
    winnerScore: 30,
    loud: { nose: 4, resin: 3, structure: 5, yield: 4, breeding: 2 },
    tags: ["Herm"],
    rounds: ["veg", "mid_flower"],
    mother: false,
    note: "Nanners at week 6 — culled.",
  },
  {
    candidateNumber: 5,
    name: "Runtz #5",
    ...
    verdict: "maybe",
    winnerScore: 58,
    loud: { nose: 6, resin: 6, structure: 6, yield: 7, breeding: 5 },
    tags: [],
    rounds: ["veg", "mid_flower", "late_flower"],
    mother: false,
    note: "Creamy; unremarkable nose.",
  },
  {
    candidateNumber: 6,
    name: "Runtz #6",
    ...
    verdict: "cull",
    winnerScore: 34,
    loud: { nose: 4, resin: 4, structure: 5, yield: 5, breeding: 3 },
    tags: ["Foxtail"],
    rounds: ["veg", "late_flower"],
    mother: false,
    note: "Foxtailed; weak.",
  },
  {
    ...
    name: "Sherb Cake",
    strain: "Sunset Runtz F2",
    aroma: ["sherbet", "vanilla", "gas"],
    verdict: "keep",
    winnerScore: 84,
    loud: { nose: 8, resin: 9, structure: 7, yield: 6, breeding: 8 },
    tags: ["Resin bomb"],
    rounds: ["veg", "early_flower", "mid_flower", "late_flower", "post_cure"],
    mother: true,
    note: "Frostiest of the pack; reversed for feminized pollen.",
  },
  {
    candidateNumber: 8,
    name: "Runtz #8",
    ...
    verdict: "maybe",
    winnerScore: 60,
    loud: { nose: 7, resin: 5, structure: 6, yield: 7, breeding: 5 },
    tags: [],
    rounds: ["veg", "mid_flower", "late_flower"],
    mother: false,
    note: "Nice berry; average frost.",
  },
];
...
export const DEMO_KEEPERS: readonly PedigreeKeeperInput[] = [
  {
    id: K_GAS,
    name: "Gas Runtz",
    sourceCandidateLabel: "#3 · Gas Runtz",
    reversed: true,
  ...
  },
  {
    id: K_CAKE,
    name: "Sherb Cake",
    sourceCandidateLabel: "#7 · Sherb Cake",
    reversed: true,
    reversalMethods: ["sts"],
    cloneCount: 1,
    stabilityRunCount: 1,
...
export const DEMO_CLONES: readonly CloneInput[] = [
  {
    id: "clone-gas-a",
    parentCloneId: null,
    cloneLabel: "Gas Runtz — mother cut",
    takenAt: "2026-04-01",
  },
  {
    id: "clone-gas-b",
    parentCloneId: "clone-gas-a",
    cloneLabel: "Gas Runtz — cut B",
    takenAt: "2026-05-10",
  },
  {
    id: "clone-gas-c",
    parentCloneId: "clone-gas-a",
    cloneLabel: "Gas Runtz — cut C",
    takenAt: "2026-05-12",
  },
  {
    id: "clone-gas-d",
    parentCloneId: "clone-gas-b",
    cloneLabel: "Gas Runtz — cut B.1",
    takenAt: "2026-06-20",
  },
];
...
export const DEMO_CROSSES: readonly PedigreeCrossInput[] = [
  {
    id: "cross-f1",
    crossName: "Gas Cake F1",
    crossType: "standard_f1",
    femaleKeeperId: K_GAS,
    maleKeeperId: K_CAKE,
    crossedAt: "2026-06-01",
  },
  {
    id: "cross-bx1",
    crossName: "Gas Cake BX1",
    crossType: "backcross",
    generation: 1,
    femaleKeeperId: K_CAKE,
    maleKeeperId: K_GAS,
    recurrentParentId: K_GAS,
    crossedAt: "2026-07-01",
  },
  {
    id: "cross-s1",
    crossName: "Gas Runtz S1",
    crossType: "selfing_s1",
    femaleKeeperId: K_GAS,
    maleKeeperId: null,
    channel: "colloidal_silver",
    crossedAt: "2026-06-15",
  },
  {
    id: "cross-op",
    crossName: "Sherb Cake OP",
    crossType: "open_pollination",
    femaleKeeperId: K_CAKE,
    maleKeeperId: null,
    crossedAt: "2026-06-20",
  },
  {
    id: "cross-unknown",
    crossName: "Cake × ?",
    ...
    femaleKeeperId: K_CAKE,
    maleKeeperId: null,
    crossedAt: "2026-06-25",
  },
  {
    id: "cross-outcross",
    crossName: "Gas × outside male",
    crossType: "standard_f1",
    femaleKeeperId: K_GAS,
    maleKeeperId: "keeper-from-another-hunt",
    crossedAt: "2026-06-28",
  },
  {
    id: "cross-bx-nogen",
    crossName: "Gas BX?",
