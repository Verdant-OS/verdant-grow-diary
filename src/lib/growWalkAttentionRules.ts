...
/** Inspection priority only; never a diagnosis or authorization to change a grow. */
...
/** Stable, non-mutating target order for a physical walkthrough. */
export function sortGrowWalkTargets(targets: readonly GrowWalkTarget[]): readonly GrowWalkTarget[] {
