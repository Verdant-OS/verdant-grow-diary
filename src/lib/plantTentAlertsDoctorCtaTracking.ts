...
export const TENT_ALERTS_DOCTOR_CTA_EVENT =
  "verdant:tent-alerts-doctor-cta" as const;
...
export function trackTentAlertsDoctorCta(
  detail: TentAlertsDoctorCtaDetail,
): void {
