...
**Verified from source at:** `7266acd6886b22b92bfdf405d04ffa8f05a4edee` (deploy branch
...
and carried to `7266acd6` when `#1712` and `#1343` merged ahead of it.
...
`package-lock.json` is cited bare.
Every other cited file is byte-identical at `9b06be3f` and `7266acd6`, so its cites hold exactly as
...
under Bun 1.3.11. The counts in §3, §4 and §10 were re-measured at `4ddb2322` and again at
`7266acd6`: AC-3.2 `*Rules.ts` 521 → 522 with every drift count unchanged, AC-3.4 unchanged,
...
tested. That reproduces all three single-line figures exactly at `4ddb2322` and `7266acd6`. The
