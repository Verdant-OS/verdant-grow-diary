...
**Last updated:** 2026-08-22 UTC (16:16 UTC)
...
**The live payments token survives the republish.** Re-measured against the new
...
**Latest release measurement is 2026-08-22 16:16 UTC** — production republished
overnight, so release identity, build time, provenance and the payments-bundle rows were
all re-read first-hand at that time (tip `93d8ea23ff58` / #1097; live `faea6e9c59ad` /
#1087; lag `6`). It supersedes the 2026-08-21 21:05 UTC and 16:15 UTC readings for those
rows. Rows not named keep their own earlier dates.
...
| Public attestation                  | **STILL INVALID** (re-measured 2026-08-22 16:16 UTC). Canonical `93d8ea23ff58`, production `faea6e9c59ad` `dirty: true`, lag `6` — see below |
...
`established fact`, measured 2026-08-22 **16:16 UTC**:

| Axis                 | Value                                                                         |
| -------------------- | ----------------------------------------------------------------------------- |
| Canonical deploy tip | `93d8ea23ff58` (#1097)                                                        |
...
| Publish lag          | **6** first-parent commits (#1095, #1096, #1098, #1091, #1099, #1097)         |

**Production republished between the two readings, and the tip moved six commits.**
Both halves of the attestation therefore changed while the verdict did not: live is
now #1087, canonical is now #1097, and the gap widened from 2 to 6. `dirty: true` and
...
you what a publish will produce**, because the file demonstrably is not what produced
the current bundle. Only the platform env panel and the publisher's build log can, and
both are owner-gated. A publish taken on the strength of this read alone is exactly the
