 ...
 *   - Grow Walk tools return scouting evidence and physical-inspection
 *     priorities only. They never diagnose, spend AI credits, save Quick Log,
 *     mutate alerts or Action Queue, or claim photo inspection from metadata.
 *
...
export default defineMcp({
  ...
  instructions:
    ...
    "separately supplied and inspected. Sensor readings always include " +
    ...
    "never current or healthy. This server never writes, never starts " +
    "AI Doctor, never spends AI credits, never approves Action Queue " +
