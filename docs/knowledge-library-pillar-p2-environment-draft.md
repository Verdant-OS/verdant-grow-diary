...
| C02  | Any room where T and RH both vary                                                                                                                      | Any room; the two terms behave differently depending on how much RH actually varies | The sign flips with the sign of the T–RH correlation                                                                                     | Sign flips with the sign of the T–RH correlation; **relative size of the two terms depends on the magnitude of RH variation**                                 | That either term dominates in general — the pillar's own constant-RH row has zero covariance |
