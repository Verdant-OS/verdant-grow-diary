  ...
  return (
    ...
    >
      <header className="space-y-1">
        ...
        <p data-testid="ai-doctor-phase1-loading-body" className="text-xs text-muted-foreground">
          Reviewing plant logs, sensor snapshots, and missing evidence.
        </p>
        <p data-testid="ai-doctor-phase1-loading-safety" className="text-xs text-muted-foreground">
          Read-only review. Nothing is being saved or sent to equipment.
        </p>
      </header>

      <div data-testid="ai-doctor-phase1-loading-skeleton-plant-header" className="space-y-2">
        <SkeletonBar width="40%" height="1rem" />
        <SkeletonBar width="60%" />
      </div>

      <div data-testid="ai-doctor-phase1-loading-skeleton-confidence-risk" className="flex gap-2">
        <SkeletonBar width="6rem" height="1.5rem" />
        <SkeletonBar width="6rem" height="1.5rem" />
      </div>

      <div data-testid="ai-doctor-phase1-loading-skeleton-evidence" className="space-y-2">
      ...
      <div data-testid="ai-doctor-phase1-loading-skeleton-sensor-summary" className="space-y-2">
        <SkeletonBar width="35%" height="0.75rem" />
        <SkeletonBar />
        <SkeletonBar width="90%" />
      </div>

      <div data-testid="ai-doctor-phase1-loading-skeleton-action-suggestion" className="space-y-2">
