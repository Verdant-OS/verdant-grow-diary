...
export const EVENT_TYPES: EventTypeDef[] = [
  { value: "observation", label: "Observation", icon: Eye, tone: "bg-secondary/60 text-foreground border-border/50" },
  { value: "watering", label: "Watering", icon: Droplets, tone: "bg-sky-500/15 text-sky-300 border-sky-500/30" },
  { value: "feeding", label: "Feeding", icon: Utensils, tone: "bg-emerald-500/15 text-emerald-300 border-emerald-500/30" },
  { value: "training", label: "Training", icon: Scissors, tone: "bg-violet-500/15 text-violet-300 border-violet-500/30" },
  { value: "defoliation", label: "Defoliation", icon: Scissors, tone: "bg-violet-500/15 text-violet-300 border-violet-500/30" },
  { value: "transplant", label: "Transplant", icon: ArrowRightLeft, tone: "bg-amber-500/15 text-amber-300 border-amber-500/30" },
  { value: "measurement", label: "Measurement", icon: FlaskConical, tone: "bg-cyan-500/15 text-cyan-300 border-cyan-500/30" },
  { value: "environment", label: "Environment check", icon: Gauge, tone: "bg-cyan-500/15 text-cyan-300 border-cyan-500/30" },
  { value: "photo", label: "Photo", icon: Camera, tone: "bg-blue-500/15 text-blue-300 border-blue-500/30" },
...
export function snapshotForTent(tentId: string): SensorSnapshot | null {
  ...
  return { temp: last.temp, rh: last.rh, vpd: last.vpd, co2: last.co2, soil: last.soil, ts: last.ts };
}
