...
export default function LineageRepairCta({ className }: { className?: string }) {
  return (
    <section
      ...
      className={
        "glass rounded-2xl p-4 flex flex-col sm:flex-row sm:items-center gap-3 " + (className ?? "")
      }
    >
      ...
      <div className="flex-1 min-w-0">
        <h3 id="lineage-repair-cta-heading" className="font-display font-semibold text-sm">
          Lineage Repair
        </h3>
        <p className="text-xs text-muted-foreground" data-testid="lineage-repair-cta-body">
          Fix tents or plants that need to be reconnected to the right grow. Changes only happen
