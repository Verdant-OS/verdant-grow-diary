...
**Last updated:** 2026-08-22 UTC (17:10 UTC)
...
**Latest release measurement is 2026-08-22 17:09 UTC** for tip and lag only
(tip `fd2d3e3f7553` / #1100; live `faea6e9c59ad` / #1087; lag **`7`**). The served
...
`established fact`, tip and lag measured 2026-08-22 **17:09 UTC**; the served-commit
rows measured **16:16 UTC** and re-confirmed unchanged at 17:09:

| Axis                 | Value                                                                         |
| -------------------- | ----------------------------------------------------------------------------- |
| Canonical deploy tip | `fd2d3e3f7553` (#1100)                                                        |
...
| Publish lag          | **7** first-parent commits (#1095, #1096, #1098, #1091, #1099, #1097, #1100)  |
...
16:16 and 17:09 UTC, production did **not** republish; only the tip advanced (#1100),
taking the lag 6 → **7**. A widening lag is not by itself evidence of a stalled
...
**Still the live build at 17:09 UTC.** `/version.json` was re-fetched at 17:09 and
returns the same commit and the same `buildTime`, so the bundle measured at 16:16 is
