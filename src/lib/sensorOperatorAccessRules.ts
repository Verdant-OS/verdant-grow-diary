 ...
 * enabled.
 */
export type OperatorRoleStatus = "loading" | "granted" | "denied" | "unauthenticated" | "error";
...
export function canShowSensorOperatorDiagnostics(input: SensorOperatorAccessInput): boolean {
