/**
 * ActionDetail header — "View saved AI Doctor session" link beside the
 * existing "Linked from AI Doctor" provenance chip.
 *
 * Read-only navigation polish. Mirrors the Coach card affordance.
 */
...
describe("ActionDetail saved-session link — static safety", () => {
  ...
  it("uses the shared route helper and pure extractor", () => {
    expect(DETAIL_SRC).toMatch(/aiDoctorSessionDetailPath\(headerSessionId\)/);
