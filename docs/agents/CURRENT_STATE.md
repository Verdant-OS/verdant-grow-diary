...
**Latest release measurement is 2026-08-21 21:05 UTC** — deploy tip and publish lag only
(tip `faea6e9c59ad` / #1087; live still `ea31fbdfb934`; lag `2`). The 16:15 UTC measurement
remains the latest for release identity and build time, which were not re-read at 21:05
beyond confirming the served commit is unchanged. Rows not named in either keep their own
earlier dates.
