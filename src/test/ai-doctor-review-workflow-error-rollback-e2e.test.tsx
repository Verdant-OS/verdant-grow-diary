...
describe("AI Doctor review workflow — error rollback", () => {
  it("Mark reviewed insert is denied → optimistic state rolls back end-to-end", async () => {
    ...
    await waitFor(() => {
      ...
      const reviewedChip = chips.find((c) => c.getAttribute("data-review-status") === "reviewed");
