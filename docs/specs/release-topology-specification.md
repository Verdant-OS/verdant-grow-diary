...
completed:
  ...
  - docs/architecture-contract.md: #1699's §9/§12/§13/§14 edits plus the §15.1 row now naming
    the 9b06be3f stamp it amends; the §9 pointer carries no dated observation. Header stamp unchanged
