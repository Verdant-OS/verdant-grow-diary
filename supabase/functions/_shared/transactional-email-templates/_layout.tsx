        ...
        >
          ...
          <Section style={{ padding: '18px 28px 24px' }}>
            <Text style={{ margin: 0, fontSize: '12px', color: brand.muted }}>
              Sent by Matt at Verdant Grow Diary. Reply directly to this email
              and it comes straight to me at{' '}
              <Link
                href="mailto:matt@verdantgrowdiary.com"
