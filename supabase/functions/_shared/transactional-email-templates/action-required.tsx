...
const Email = ({
  ...
  <EmailLayout preview={headline}>
    ...
    <Text style={{ ...styles.muted, marginTop: "18px" }}>
      ...
      <br />
      <span style={{ color: brand.surfaceText, wordBreak: "break-all" }}>{actionUrl}</span>
    </Text>
    <Text style={{ ...styles.p, marginTop: "20px" }}>
      If you weren&rsquo;t expecting this or something looks wrong, reply and I&rsquo;ll take a look
      before anything changes on your account.
    </Text>
    {signOff()}
  </EmailLayout>
);
