...
`docs/agent-session-network-reachability.md`. Docs-only; no code, schema, or
migration changes. Does **not** measure indexation or migration state, and does
**not** set Day 0.)
...
| Public sitemap                              | `PASS` — HTTP 200, **56** `<loc>` entries (live re-count 2026-08-20; unchanged from 2026-08-15 and 2026-08-12). First loc is `https://verdantgrowdiary.com/`                                                                                                                                                                                                                                                                                                                                                                                                          |
...
| Indexable routes outside the sitemap        | `FAIL` — re-confirmed 2026-08-20, unchanged: `/glossary`, `/breeder-beta`, `/creator-beta`, `/pheno-comparison` each serve HTTP 200 with `<meta name="robots" content="index, follow">` and are absent from `sitemap.xml`. Two are beta surfaces and one is a preview; still no recorded eligibility decision — see blocker 8’s sibling note                                                                                                                                                                                                                          |
