...
const Email = ({
  ...
  <EmailLayout preview="Welcome to Verdant — a quick start to your first grow.">
    <Text style={styles.h1}>{firstName ? `Welcome, ${firstName}.` : "Welcome to Verdant."}</Text>
    <Text style={styles.p}>
      Verdant is plant memory and sensor truth for serious growers. Grower decides, always — Verdant
      just makes the evidence easier to read.
    </Text>
    ...
    <Text style={{ ...styles.p, marginTop: "20px" }}>
      Reply to this email with anything confusing, broken, or missing. I read every one.
    </Text>
    {signOff()}
  </EmailLayout>
);
