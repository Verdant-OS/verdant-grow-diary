...
| AT-10 | The document contains no secret, token, connection string, or private environment value. The platform identifiers it records are locators, not credentials: team and project IDs (A.3), the Lovable workspace and project IDs (A.5), and truncated deployment IDs (Appendices A and B)                                                                                                                                                         | `PASS`                                                                                                                                                                                                                  |
