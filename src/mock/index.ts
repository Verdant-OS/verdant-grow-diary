 ...
 */
export type SensorReadingSource = "live" | "manual" | "csv" | "demo" | "stale" | "invalid";
 ...
 */
export type SensorReadingHealthStatus = "usable" | "stale" | "invalid" | "needs_review" | "no_data";
...
export interface SensorReading {
  ...
  /** Persisted ingest quality. Exact `ok` is required for current Live claims. */
  quality?: string | null;
  /**
...
export const tents: Tent[] = [
  ...
  },
  {
    ...
    size: "2x2",
    stage: "seedling",
    light: { on: true, schedule: "20/4", wattage: 100 },
    alertCount: 0,
  },
  {
    id: "t4",
    ...
    size: "5x5",
    stage: "flush",
    light: { on: false, schedule: "12/12", wattage: 650 },
    alertCount: 2,
  },
];
...
export const plants: Plant[] = [
  {
    ...
    health: "healthy",
    photo: PHOTO("1536819114556-1c10c4b1cf8a"),
    lastNote: "Trichomes turning cloudy",
  },
  {
    id: "p2",
    name: "GG #2",
    ...
    startedAt: "2026-02-10",
    health: "watch",
    photo: PHOTO("1503262028195-93c528f03218"),
    lastNote: "Slight nute burn on tips",
  },
  {
    id: "p3",
    name: "ZK #1",
    ...
    health: "healthy",
    photo: PHOTO("1518915334520-5cb1c1f8e123"),
    lastNote: "LST applied",
  },
  {
    id: "p4",
    name: "ZK #2",
    ...
    startedAt: "2026-03-15",
    health: "healthy",
    photo: PHOTO("1530836369250-ef72a3f5cda8"),
    lastNote: "Topped at node 5",
  },
  {
    id: "p5",
    name: "WW Auto",
    ...
    health: "healthy",
    photo: PHOTO("1466692476868-aef1dfb1e735"),
    lastNote: "First true leaves",
  },
  {
    id: "p6",
    name: "BD #1",
    ...
    health: "issue",
    photo: PHOTO("1507371341162-763b5e419408"),
    lastNote: "Late-flower yellowing",
  },
];
...
function genReadings(): SensorReading[] {
  ...
  for (const t of tents) {
    ...
    for (let h = 24 * 7; h >= 0; h--) {
      ...
      const vpd = +Math.max(
        0.4,
        (1 - rh / 100) * (0.6108 * Math.exp((17.27 * temp) / (temp + 237.3))),
      ).toFixed(2);
...
export const cameras: Camera[] = [
  {
    ...
    name: "Tent A · Front",
    online: true,
    thumbnail: PHOTO("1536819114556-1c10c4b1cf8a"),
    lastFrameAt: new Date(Date.now() - 60_000).toISOString(),
  },
  {
    id: "c2",
    tentId: "t2",
    name: "Tent B · Top",
    online: true,
    thumbnail: PHOTO("1518915334520-5cb1c1f8e123"),
    lastFrameAt: new Date(Date.now() - 90_000).toISOString(),
  },
  {
    id: "c3",
    tentId: "t3",
    name: "Tent C · Side",
    online: false,
    thumbnail: PHOTO("1466692476868-aef1dfb1e735"),
    lastFrameAt: new Date(Date.now() - 6 * 3600_000).toISOString(),
  },
  {
    id: "c4",
    tentId: "t4",
    name: "Tent D · Front",
    online: true,
    thumbnail: PHOTO("1507371341162-763b5e419408"),
    lastFrameAt: new Date(Date.now() - 120_000).toISOString(),
  },
];
...
export const tasks: Task[] = [
  ...
  {
    id: "k3",
    title: "Defoliate lower fans (Tent A)",
    type: "defoliation",
    tentId: "t1",
    dueAt: addDays(1),
    status: "upcoming",
...
export const alerts: Alert[] = [
  {
    ...
    source: "sensor",
    tentId: "t4",
    title: "RH spike in Tent D",
    detail: "Humidity at 71% for 90 minutes during flush.",
  ...
  },
  {
    ...
    detail: "VPD 1.7 kPa — above 1.5 ceiling for flower.",
  ...
  },
  {
    ...
    detail: "Tent C watering was scheduled 18h ago.",
  ...
  },
  {
    ...
    detail: "GG #1 trichomes likely 10–14 days from peak ripeness.",
...
export const aiInsights: AIInsight[] = [
  {
    id: "i1",
    tentId: "t4",
    title: "Mold risk rising in Tent D",
    summary: "Sustained 65%+ RH during late flower combined with lights-off temp drops.",
    confidence: 0.82,
    recommendations: [
      "Increase exhaust fan to 70%",
      "Add a small dehumidifier targeting 45–50% RH",
      "Defoliate inner-canopy fans for airflow",
    ],
  },
  {
    id: "i2",
    tentId: "t1",
    plantId: "p2",
    title: "Mild nute burn on GG #2",
    summary: "Tip burn on upper colas suggests EC slightly high for flower stage.",
    confidence: 0.74,
    recommendations: [
      "Drop EC to 1.6 next feed",
      "Plain-water flush at next watering",
      "Re-test runoff EC after 2 cycles",
    ],
  },
  {
    id: "i3",
    ...
    summary: "Tent B nodes 4–6 ideal for low-stress training to flatten the canopy.",
    confidence: 0.91,
    recommendations: [
      "Apply LST to side branches",
      "Tuck dominant cola tips",
      "Re-evaluate canopy in 5 days",
    ],
  },
];
