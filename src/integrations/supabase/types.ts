  ...
  public: {
    Tables: {
      ...
      soil_moisture_calibrations: {
        ...
        Relationships: [
          {
            foreignKeyName: "soil_moisture_calibrations_grow_id_fkey"
            columns: ["grow_id"]
            isOneToOne: false
            referencedRelation: "grows"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "soil_moisture_calibrations_plant_id_fkey"
            columns: ["plant_id"]
            isOneToOne: false
            referencedRelation: "plants"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "soil_moisture_calibrations_tent_id_fkey"
            columns: ["tent_id"]
            isOneToOne: false
            referencedRelation: "tents"
            referencedColumns: ["id"]
