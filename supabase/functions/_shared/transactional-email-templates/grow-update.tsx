...
const Email = ({
  ...
  <EmailLayout preview={`Grow update: ${growName}${tentName ? ` / ${tentName}` : ""}`}>
    ...
    <Text style={styles.p}>
      ...
      . This is an observation from your own logs and sensors — no automation ran and nothing was
    ...
    <Text style={{ ...styles.muted, marginTop: "18px" }}>
      Want fewer of these, or a different cadence? Adjust email preferences in your{" "}
      <a href="https://verdantgrowdiary.com/account/notifications" style={{ color: brand.primary }}>
        account settings
      </a>
      .
    </Text>
