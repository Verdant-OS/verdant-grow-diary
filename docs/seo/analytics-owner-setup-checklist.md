...
**Last verified (UTC):** 2026-07-31T23:10:32.9711027Z
...
repair are live; public direct-load/indexability checks and the GA4 collection contract pass. One
non-launch-blocking route-runtime structured-data defect remains tracked separately. The owner has
...
1. Complete the GA4 property identity, read-only access, and filter decisions; the production
   stream identity is already recorded above.
