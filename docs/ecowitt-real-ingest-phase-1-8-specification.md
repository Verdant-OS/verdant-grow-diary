...
(2026-08-12). Approval is blocked on the verification items (V1/V3/V4/V6 `BLOCKED` on the single
live-access grant; V2 and V5a `PASS`; V5b resolves with D4) **and, independently, on the owner's D4 re-confirmation** against the
