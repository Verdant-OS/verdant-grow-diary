...
export const AI_DOCTOR_CONTEXT_READINESS_CONFIG = Object.freeze({
  recentEventWindowMs: AI_DOCTOR_RECENT_EVENT_WINDOW_DAYS * 24 * 60 * 60 * 1000,
  snapshotFreshMs: AI_DOCTOR_SNAPSHOT_FRESH_HOURS * 60 * 60 * 1000,
});

export type AiDoctorContextReadinessConfig = typeof AI_DOCTOR_CONTEXT_READINESS_CONFIG;
 ...
 */
export const AI_DOCTOR_CONTEXT_TOOLTIPS: Readonly<Record<string, string>> = Object.freeze({
  ...
  "recent-watering-or-feeding": "Present when a watering or feeding entry was logged recently.",
  ...
  "recent-warnings": "Present when recent warnings or invalid sensor snapshots exist.",
});

/** Missing-side tooltip overrides where wording should differ from evidence. */
export const AI_DOCTOR_CONTEXT_MISSING_TOOLTIPS: Readonly<Record<string, string>> = Object.freeze({
  "recent-warnings": "No recent warnings or invalid sensor snapshots on file.",
