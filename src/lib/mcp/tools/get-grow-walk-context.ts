...
export default defineTool({
  ...
  description:
    ...
    "and partial lanes are named explicitly. The result supports physical inspection and " +
      ...
      content: [
        {
          ...
          text:
            partial === 0
              ? `Grow Walk context ready for "${scope}".`
              : `Grow Walk context ready for "${scope}" with ${partial} explicit partial evidence lane(s).`,
        },
      ],
