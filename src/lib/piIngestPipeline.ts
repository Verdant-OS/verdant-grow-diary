...
import { validateBridgeBatchScope, type BridgeBatchScopeResult } from "./piIngestBridgeRules";
import { evaluateBridgeAbuseGuard, type BridgeAbuseGuardResult } from "./piIngestRateLimitRules";
import {
  toExternalSensorIngestPayload,
  validatePiIngestRequestEnvelope,
...
export type PiIngestPipelineStage =
  "auth" | "envelope" | "abuse_guard" | "normalization" | "batch_scope";
