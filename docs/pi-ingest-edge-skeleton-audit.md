...
| #   | Question                                                                     | Finding                                                                                                                                                                                                                                                               |
| --- | ---------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | Does the function fail closed?                                               | **Yes.** Every error path returns a generic 401/400/405/503 from `piIngestFailClosedResponses`. Missing env config → 503 with the legacy `secret_resolver_not_implemented` wire code and a current server-configuration-unavailable message.                          |
