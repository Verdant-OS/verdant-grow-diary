...
-- candidates or picks a phenotype. Backs the Pro Pheno Comparison scorecard so
-- the side-by-side stops showing "Not recorded" once a grower rates candidates.
--
...
--
-- Schema is intentionally byte-identical to the deploy branch's
-- pheno_candidate_scores foundation so the two lineages converge and the
-- eventual Lovable port carries only app code (the table already exists there).
