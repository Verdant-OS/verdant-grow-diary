...
const MIGRATION_VERSION = "20260824180000";
const MIGRATION_NAME = "agreement_acceptance_insert_forward_repair";
const MIGRATION_SHA256 = "290C69365994681721DEE1A13337E6CAECAB31D169B17047E36052781BEC87F2";
...
function validateReceipt(value, expected, runAttempt, priorRun) {
  ...
  if (
    ...
    value.tool !== "apply-agreement-acceptance-insert-forward-repair" ||
...
async function main(env = process.env) {
  try {
    ...
    console.log("Authenticated Agreement acceptance insert PREFLIGHT artifact validated.");
    return 0;
  } catch {
    console.error(
      "Authenticated Agreement acceptance insert PREFLIGHT artifact validation failed closed.",
    );
    return 1;
  }
}
