...
import { PHENO_COMPARISON_MIN_CANDIDATES } from "@/lib/phenoHuntCandidateSelectionRules";

export const PHENO_HUNT_MIN_CANDIDATES = PHENO_COMPARISON_MIN_CANDIDATES;
