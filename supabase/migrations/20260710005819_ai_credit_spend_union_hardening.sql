...
-- (1) live /pricing buyers (Lovable subscriptions table) were metered free;
-- (2) canceled/expired BYO pro rows kept the monthly Pro allowance.
...
BEGIN
  ...
  -- plan ids). Only an active, unexpired row counts.
  SELECT s.price_id
    INTO v_lov_plan
