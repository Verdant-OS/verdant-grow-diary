...
BEGIN
  ...
  IF NEW.source NOT IN (
    ...
    -- Contract-aligned generic labels for MQTT/EcoWitt/HA/CSV bridges.
    -- Vendor lineage (e.g. "ecowitt") travels in raw_payload.vendor and is
    -- NEVER used for auth or routing.
    'ecowitt','mqtt','csv','webhook'
  ) THEN
