...
export const WORKFLOW_PATH = ".github/workflows/apply-quicklog-revision-idempotent-replay.yml";
export const ARTIFACT_PREFIX = "quicklog-revision-idempotent-replay-preflight";
...
const MIGRATION_VERSION = "20260916111000";
const MIGRATION_NAME = "quicklog_revision_idempotent_replay";
const MIGRATION_SHA256 = "CE6A9DBFB51CAF5CE20256EA0C957F88EC8FD76D6A4047BA6832B25A7933D70C";
...
function validateReceipt(value, expected, runAttempt, priorRun) {
  ...
  if (
    ...
    value.tool !== "apply-quicklog-revision-idempotent-replay" ||
...
async function main(env = process.env) {
  try {
    ...
    console.log("Authenticated Quick Log revision replay PREFLIGHT artifact validated.");
    return 0;
  } catch {
    console.error(
      "Authenticated Quick Log revision replay PREFLIGHT artifact validation failed closed.",
    );
    return 1;
  }
}
