...
export const WORKFLOW_PATH = ".github/workflows/apply-plants-health-unassessed-default.yml";
export const ARTIFACT_PREFIX = "plants-health-unassessed-default-preflight";
...
const MIGRATION_VERSION = "20260924120000";
const MIGRATION_NAME = "plants_health_unassessed_default";
const MIGRATION_SHA256 = "70FCA107B96E74B1E6B0100EBEB53E404CFD9407E50251273E592CF7EE0098FC";
...
function validateReceipt(value, expected, runAttempt, priorRun) {
  ...
  if (
    ...
    value.tool !== "apply-plants-health-unassessed-default" ||
...
async function main(env = process.env) {
  try {
    ...
    console.log("Authenticated plants health default PREFLIGHT artifact validated.");
    return 0;
  } catch {
    console.error(
      "Authenticated plants health default PREFLIGHT artifact validation failed closed.",
    );
    return 1;
  }
}
