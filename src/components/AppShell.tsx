...
export default function AppShell({ children }: { children?: ReactNode }) {
  ...
  useEffect(() => {
    function onOpen(e: Event) {
      ...
      // GlobalSearch shortcuts, fastAddActionRules presets) flows through
      // this one listener, so stamping logged_at here — only when the
      // dispatcher did not carry its own — gives all entry points the click
      // moment uniformly without touching each dispatcher.
      const seeded =
