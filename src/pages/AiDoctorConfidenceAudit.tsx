 ...
 *
 * Renders the static AiDoctorConfidenceAuditViewModel. Does NOT query live
 * data, call Supabase, write data, create alerts, create Action Queue items,
 * call models, or control devices.
 */
