...
**Last updated:** 2026-08-22 UTC (18:22 UTC)
...
Tip and lag re-measured 18:22 UTC: tip `70ba566cdb11` (#1092), publish lag **10**;
...
**Latest release measurement is 2026-08-22 18:22 UTC** for tip and lag only
(tip `70ba566cdb11` / #1092; live `faea6e9c59ad` / #1087; lag **`10`**). The served
...
`established fact`, tip and lag measured 2026-08-22 **18:22 UTC**; the served-commit
rows measured **16:16 UTC** and re-confirmed unchanged at 17:09, 17:32, 17:51 and 18:22:

| Axis                 | Value                                                                                              |
| -------------------- | -------------------------------------------------------------------------------------------------- |
| Canonical deploy tip | `70ba566cdb11` (#1092)                                                                             |
...
| Publish lag          | **10** first-parent commits (#1095, #1096, #1098, #1091, #1099, #1097, #1100, #1101, #1102, #1092) |
...
16:16 and 18:22 UTC, production did **not** republish at all; only the tip advanced
(#1100, #1101, #1102, #1092), taking the lag 6 → 7 → 8 → 9 → **10**. A widening lag is not by itself evidence of a stalled
...
**Still the live build at 18:22 UTC.** `/version.json` was re-fetched at 17:09, 17:32,
17:51 and 18:22, returning the same commit and the same `buildTime` each time, so the bundle measured at 16:16 is
