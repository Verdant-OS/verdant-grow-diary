...
Tip and lag re-measured 17:32 UTC: tip `8e6750e87aff` (#1101), publish lag **8**;
production still serves `faea6e9c59ad`, unchanged since 16:16 UTC.
...
**Latest release measurement is 2026-08-22 17:32 UTC** for tip and lag only
(tip `8e6750e87aff` / #1101; live `faea6e9c59ad` / #1087; lag **`8`**). The served
...
| Public attestation                  | **STILL INVALID** (tip/lag re-measured 2026-08-22 17:32 UTC). Canonical `8e6750e87aff`, production `faea6e9c59ad` `dirty: true`, lag **`8`** — see below                                                                                                                                                                                                                                                                                                                                                                                        |
...
`established fact`, tip and lag measured 2026-08-22 **17:32 UTC**; the served-commit
rows measured **16:16 UTC** and re-confirmed unchanged at 17:09 and again at 17:32:

| Axis                 | Value                                                                               |
| -------------------- | ----------------------------------------------------------------------------------- |
| Canonical deploy tip | `8e6750e87aff` (#1101)                                                              |
...
| Publish lag          | **8** first-parent commits (#1095, #1096, #1098, #1091, #1099, #1097, #1100, #1101) |
...
16:16 and 17:32 UTC, production did **not** republish at all; only the tip advanced
(#1100, then #1101), taking the lag 6 → 7 → **8**. A widening lag is not by itself evidence of a stalled
...
**Still the live build at 17:32 UTC.** `/version.json` was re-fetched at 17:09 and
again at 17:32, returning the same commit and the same `buildTime` each time, so the bundle measured at 16:16 is
