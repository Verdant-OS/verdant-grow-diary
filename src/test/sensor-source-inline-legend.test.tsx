...
describe("SensorSourceInlineLegend", () => {
  ...
  it("highlights matching source kinds when provided", () => {
    ...
    expect(screen.getByTestId("sensor-source-inline-legend-row-live")).toHaveAttribute(
      "data-highlighted",
      "true",
    );
    expect(screen.getByTestId("sensor-source-inline-legend-row-csv")).toHaveAttribute(
      "data-highlighted",
      "true",
    );
    expect(screen.getByTestId("sensor-source-inline-legend-row-manual")).toHaveAttribute(
      "data-highlighted",
      "false",
    );
  });
