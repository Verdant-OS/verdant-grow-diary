...
const DEFAULT_FRESH_MS = 15 * 60 * 1e3;
...
const SENSOR_SNAPSHOT_STALE_THRESHOLD_MS = 15 * 60 * 1e3;
const SENSOR_READING_NORMALIZATION_STALE_MS = 15 * 60 * 1e3;
const DEFAULT_AI_COACH_STALE_THRESHOLD_MS = 15 * 60 * 1e3;
const DEFAULT_AI_SENSOR_STALE_THRESHOLD_MS = 15 * 60 * 1e3;
const ECOWITT_CHANNEL_LABELING_STALE_AFTER_MS = 60 * 60 * 1e3;
const DEFAULT_SENSOR_STALE_MS = 24 * 60 * 60 * 1e3;
