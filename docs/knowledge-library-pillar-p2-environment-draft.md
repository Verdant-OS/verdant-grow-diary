...
| C09  | §5             | _Botrytis cinerea_ is favoured by cool temperatures with high RH and free water on plant surfaces; extension guidance recommends holding greenhouse RH **below 50%** and improving airflow. **65–75 °F from S6a (read); the 50–80 °F range and 68 °F optimum from S6b (NOT read)**                     | R2     | pathogen risk           | Source-reported                                                                                       | S6a (`supports` — 65–75 °F, RH<50%); S6b (`supports` — 68 °F optimum, **unverified**)                                                                                          | Hemp/greenhouse **proxy setting**                                                   |
...
| C09  | Hemp, greenhouse-framed                                                                                                                                | °F, % RH                                        | Greenhouse is not a sealed indoor room; hemp is not all cannabis; "below 50%" is greenhouse guidance                                                                                                                                                                  | Greenhouse is not a sealed indoor room; hemp is not all cannabis; "below 50%" is greenhouse guidance; **the 68 °F optimum rests on an unread source**         |
