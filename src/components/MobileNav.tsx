...
import { LayoutDashboard, Box, NotebookText, ListChecks, Bell, MoreHorizontal, Sprout, Activity, Stethoscope, Settings, ClipboardCheck, ClipboardList } from "lucide-react";
